...
import { loadAllOrders, orderStatuses, saveCustomerOrder, saveDeliveryProof, updateOrderStatus, uploadDeliveryProof, type CustomerDetails, type StoreOrder } from './lib/orders';
