...
function Marquee() {
  return <div className="overflow-hidden border-y border-[#f3eee4]/15 py-4 font-mono-ui text-[10px] uppercase tracking-[.24em] text-[#f3eee4]/60"><div className="marquee-track flex w-max"><span className="flex items-center gap-8 pr-8">Thoughtful materials <i className="h-1.5 w-1.5 rounded-full bg-[#bd8250]" /> Made to be lived in <i className="h-1.5 w-1.5 rounded-full bg-[#b99a63]" /> See it in your room <i className="h-1.5 w-1.5 rounded-full bg-[#bd8250]" /></span><span className="flex items-center gap-8 pr-8">Thoughtful materials <i className="h-1.5 w-1.5 rounded-full bg-[#bd8250]" /> Made to be lived in <i className="h-1.5 w-1.5 rounded-full bg-[#b99a63]" /> See it in your room <i className="h-1.5 w-1.5 rounded-full bg-[#bd8250]" /></span></div></div>;
}
